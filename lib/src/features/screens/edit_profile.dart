...
class _EditProfileScreenState extends State<EditProfileScreen> {
                            ...
                            Container(
                              ...
                              child: _image == null
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: _getprofileApi!.data.image.toString(),
                                  fit: BoxFit.fill,
                                  width: 100,
                                  height: 100,
  ...
  Future<void>profileapi() async {
    ...
    try {
      var res = await http.get(Uri.parse(Api.getprofile+"?user_id=${user_id}"),);
      ...
      if (res.statusCode == 200) {
        try {
          ...
          if (model.status == "true") {
            ...
            final prefs = await SharedPreferences.getInstance();
            await prefs.setString('user_id',profileModel!.data!.userId.toString());
            await prefs.setString('name', profileModel!.data!.name.toString());
            await prefs.setString('address', profileModel!.data!.address.toString());
            await prefs.setString('mobile',profileModel!.data!.mobile.toString());
            await prefs.setString('email', profileModel!.data!.email.toString());
