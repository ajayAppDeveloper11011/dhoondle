                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                                child: Text(results[index]["address"],
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                        onTap: ()  {
                                          _launchPhoneCall(results[index]['mobileNumber']);
                                    ...
                                    InkWell(
                                        onTap: () => {
                                          launchWhatsApp(results[index]['mobileNumber'])
                                        },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(20),
                                      child: CachedNetworkImage(
                                        imageUrl:getPropertyList!.propertyList[index].image.toString(),
                                        fit: BoxFit.fill,
                                        height: size.height*0.25,
                                        width: size.width,
                                        placeholder: (context, url) =>
                                  ...
                                  Positioned(
                                      ...
                                      child: Container(
                                          ...
                                          child: Text("Rent:${getPropertyList!.propertyList[index].price.toString()}"))),
                                ],
                              ),
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                                child: Text(   "${getPropertyList!.propertyList[index].category.toString()} available for rent",style: GoogleFonts.poppins(
                                    color: AppColors.textcolor,
                                    fontWeight: FontWeight.w400,
                                    fontSize: 16
                                ),),
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                                child: Text(getPropertyList!.propertyList[index].address.toString(), style: GoogleFonts.poppins(
                                    color: AppColors.greycolor,
                                    fontWeight: FontWeight.w400,
                                    fontSize: 14
                                ),),
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                                child: Text(getPropertyList!.propertyList[index].city.toString(), style: GoogleFonts.poppins(
                                    color: AppColors.greycolor,
                                    fontWeight: FontWeight.w400,
                                    fontSize: 14
                                ),),
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = locationList
          .where((user) =>
          user["category"].toLowerCase().contains(enteredKeyword.toLowerCase()))
          .toList();
    }
    // Refresh the UI
    setState(() {
