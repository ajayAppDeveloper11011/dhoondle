                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: getPropertyDetailModel!.propertyImage![index].image.toString() ,
                                  fit: BoxFit.fill,
                                  height: size.height * 0.25,
                            ...
                            Positioned(
                                ...
                                child: Container(
                                    ...
                                    child: Text("Rent:${getPropertyDetailModel!.propertyDetails!.price.toString()}"))),
                          ],
                        ));
                      },
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                           getPropertyDetailModel!.propertyDetails!.description.toString(),
                            style: GoogleFonts.roboto(
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            getPropertyDetailModel!.propertyDetails!.address.toString(),
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            getPropertyDetailModel!.propertyDetails!.city.toString(),
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                              getPropertyDetailModel!.propertyDetails!.roomtype.toString(),
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        try {
          ...
          GetPropertyDetailModel model = GetPropertyDetailModel.fromJson(jsonResponse);
