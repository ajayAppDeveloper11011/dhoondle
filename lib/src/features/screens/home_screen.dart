...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:Stack(
        children: [
          getPropertyList==null?Container(
            height: 400,
            child: Center(child: Text("No property found")),):
          Container(
            height: size.height,
            width: size.width,
            child: getPropertyList!.propertyList.isEmpty?Container(
              height: 400,
              child: Center(child: Text("No property found")),):
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () => {
                      Get.to(PropertyDetailsScreen(property_id:getPropertyList!.propertyList[index]!.propertyId.toString(),))
