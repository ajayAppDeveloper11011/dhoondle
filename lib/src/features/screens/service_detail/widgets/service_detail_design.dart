                                              ...
                                              child: Center(
                                                  child: ClipOval(
                                                    child: Image.asset(
                                                      Images.man,
                                                      height: 80,
                                                      width:MediaQuery.of(context).size.width*0.2 ,fit: BoxFit.cover,
                                                    ),
                                                  )),
                                            ),
                                      ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(" ${ servicedetailController.serviceDetailModel!.data![index].yearsOfExperience.toString()} years",overflow: TextOverflow.ellipsis,
                                            style: GoogleFonts.poppins(
                                                fontSize: 13,
