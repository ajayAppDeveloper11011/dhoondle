                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: Image.asset(Images.house,fit:BoxFit.fill,)),
                      ),
                      ...
                      Container(
                        ...
                        width: size.width/2.3,
                        child: Center(
                          child: Text(TextScreen.Property,style: GoogleFonts.poppins(
                            textStyle: TextStyle(color: Color(0xff4E4E4E), fontWeight: FontWeight.w500, fontSize: 20),
                          ),),
                        ),
                      ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.asset(Images.setting,fit:BoxFit.fill,)),
                      ),
                      ...
                      Container(
                        ...
                        width: size.width/2.3,
                        child: Center(
                          child: Text(TextScreen.other_service,style: GoogleFonts.poppins(
                            textStyle: TextStyle(color: Color(0xff4E4E4E), fontWeight: FontWeight.w500, fontSize: 20),
                          ),),
                        ),
                      ),
