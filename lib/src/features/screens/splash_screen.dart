          ...
          children: [
            Obx(
                  ...
                  duration: Duration(milliseconds: 1600),
                      alignment:splashController.animate.value? Alignment.center:Alignment.topCenter,
                  // top: splashController.animate.value?200:-200,
                  // left:splashController.animate.value?80:-200,

                  child: AnimatedOpacity(opacity:  splashController.animate.value?1:0,
            ...
            Obx(
                  ...
                  child: Padding(
                    ...
                    child: AnimatedOpacity(
                      ...
                      duration: Duration(milliseconds: 1000),
                      child: Text(TextScreen.DHOONDLE, style: GoogleFonts.roboto(
                          color: Colors.black,
