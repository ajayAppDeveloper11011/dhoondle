                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  children: [
                    Text("Congratulations",  style: GoogleFonts.poppins(
                      textStyle: TextStyle(color: Color(0xff4E4E4E), fontWeight: FontWeight.w500, fontSize: 30),)),
                    Image.asset(Images.congratulation2)
                  ],

                ),
                Text("You are now subscribed for a month. ",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Color(0xff4C4C4C), fontWeight: FontWeight.w400, fontSize: 18),)),
                SizedBox(height: 300,),
